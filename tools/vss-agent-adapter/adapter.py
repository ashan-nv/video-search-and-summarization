...
def build_bootstrap(manifest, base_url):
    ...
    lines = [
        ...
        "These are provided by the VSS deployment. They are SEPARATE from any",
        "skills your own harness ships with -- when asked what you can do with",
        "VSS, or what VSS skills exist, answer from THIS list, not your built-in",
        "skill registry. Both can coexist; neither replaces the other.",
        "",
        "Each is a set of instructions for one task. When a request matches a",
        "description, FETCH that skill's instructions and follow them:",
